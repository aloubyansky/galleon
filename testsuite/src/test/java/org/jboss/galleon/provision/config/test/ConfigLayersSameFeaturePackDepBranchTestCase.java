    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        creator.newFeaturePack()
            ...
            .addConfigLayer(ConfigModel.builder("model1", "ejb")
                    .addLayerDep("base")
                    .includeFeature(FeatureId.create("specA", "id", "base-prod1"), new FeatureConfig().setParam("p3", "ejb"))
                    .addFeature(new FeatureConfig("specA")
            ...
            .addConfigLayer(ConfigModel.builder("model1", "undertow")
                    .addLayerDep("base")
                    .includeFeature(FeatureId.create("specA", "id", "base-prod1"), new FeatureConfig().setParam("p4", "undertow"))
                    .addPackageDep("undertow")
                    .build())
            .addConfigLayer(ConfigModel.builder("model1", "layer-x")
                    .addLayerDep("base")
        ...
        creator.newFeaturePack()
            ...
            .addDependency(prod1)
            .addConfigLayer(ConfigModel.builder("model1", "ejb-plus")
                .addFeature(new FeatureConfig("specA")
