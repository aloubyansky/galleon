    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningException {
        ...
        creator.newFeaturePack()
            ...
            .addFeatureSpec(FeatureSpec.builder("specA")
                    ...
                    .build())
            .addConfigLayer(ConfigModel.builder("model1", "base")
                    ...
                    .addPackageDep("base")
                    .build())
            .addConfigLayer(ConfigModel.builder("model1", "ejb")
                    .addLayerDep("base")
                    .excludeSpec("specA")
                    .includeFeature(FeatureId.create("specA", "p1", "base"),
                            new FeatureConfig()
                            .setParam("p3", "ejb")
                            .setParam("p4", "ejb"))
                    .includeFeature(FeatureId.create("specA", "p1", "base1"))
                    .addFeature(new FeatureConfig("specA").setParam("p1", "ejb"))
                    .addPackageDep("ejb")
                    .build())
            .addConfigLayer(ConfigModel.builder("model1", "undertow")
                    .addLayerDep("base")
                    .excludeSpec("specA")
                    .includeFeature(FeatureId.create("specA", "p1", "base"), new FeatureConfig().setParam("p3", "undertow"))
                    .includeFeature(FeatureId.create("specA", "p1", "base2"))
                    .addFeature(new FeatureConfig("specA").setParam("p1", "undertow"))
                    .addPackageDep("undertow")
                    .build())
            .addConfig(ConfigModel.builder("model1", "name1")
                    .addLayerDep("ejb")
                    .addLayerDep("undertow")
        ...
        return ProvisionedState.builder()
                ...
                .addConfig(ProvisionedConfigBuilder.builder()
                        ...
                        .addFeature(ProvisionedFeatureBuilder.builder(
                                ...
                                .setConfigParam("p3", "undertow")
                                .setConfigParam("p4", "ejb")
                        ...
                        .addFeature(ProvisionedFeatureBuilder.builder(
                                ...
                                .build())
                        .addFeature(ProvisionedFeatureBuilder.builder(
                                ResolvedFeatureId.create(prod1.getProducer(), "specA", "p1", "base2"))
                                .setConfigParam("p2", "spec")
                                .build())
                        .addFeature(ProvisionedFeatureBuilder.builder(
